...
from ddqn.agent.dqn_agent import DQNAgent


def args_parse():
    parser = argparse.ArgumentParser(description="Atari: DQN vs DDQN")
    parser.add_argument('--env', default="BreakoutNoFrameskip-v4", help='Should be NoFrameskip environment')
    parser.add_argument('--algorithm', default="ddqn", choices=["dqn", "ddqn"], help='Algorithm to use: dqn or ddqn')
